<div class="hidden sm:flex sm:items-center ">
    <x-dropdown align="right" width="48">
        ...
        <x-slot name="content">
            ...
            <x-dropdown-link :href="route('flashcards.edit', $mydat)">
                {{ __('Edit') }}
            </x-dropdown-link>

            <form method="POST" action="{{ route('flashcards.destroy', $mydat) }}">
                @csrf
                @method('DELETE')
                <x-dropdown-link :href="route('flashcards.destroy', $mydat)"
