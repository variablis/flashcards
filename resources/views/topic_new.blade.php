<x-app-layout>
    ...
    <form method="POST" action={{ route('topics.store') }}>
        ...
        <div>
            ...
            <x-text-input id="tpc_title" class="block mt-1 w-full" type="text" name="title" :value="old('title')" required autofocus />
        ...
        <label class="relative inline-flex items-center cursor-pointer">
            <input name="is_public" type="checkbox" value="1" {{ old('is_public') == '1' ? 'checked' : '' }} class="sr-only peer" >
