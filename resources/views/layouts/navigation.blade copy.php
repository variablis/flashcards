            ...
            <div class="flex items-center justify-start">
                ...
                {{-- <div class="shrink-0 flex items-center">
                    <a href="{{ route('expl') }}">
                        ...
                        <a href="{{ route('expl') }}" class="flex ml-2 md:mr-24">
                          {{-- <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo" /> --}}
                          <x-application-logo class="mr-3 block h-8 w-auto fill-current text-gray-800" />
                          <span class="self-center text-xl font-b tracking-tight sm:text-2xl whitespace-nowrap dark:text-white">Flashcards</span>
                        </a>
                      </div>
